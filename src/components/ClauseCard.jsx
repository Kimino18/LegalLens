...
window.ClauseCard = function ClauseCard({ clause }) {
  ...
  const sev = SEVERITY_STYLES[clause.severity] || SEVERITY_STYLES.info;
      ...
      <div className="p-4 sm:p-5">
        ...
        <header className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <h4 className="font-bold text-[15px] text-navy m-0 truncate">
...
>
  {window.highlightKeyword(
    clause.snippetText || clause.snippet || "",
    clause.keyword || "",
    sev.text
  )}
</blockquote>
